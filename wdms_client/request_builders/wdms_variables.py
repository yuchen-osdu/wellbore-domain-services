...
variables_dict = {
  ...
  "osduWellboreKind": "osdu:wks:master-data--Wellbore:1.1.0",
  "osduWellKind": "osdu:wks:master-data--Well:1.1.0",
  ...
  "osduWellboreMarkerSetKind": "osdu:wks:work-product-component--WellboreMarkerSet:1.2.0",
