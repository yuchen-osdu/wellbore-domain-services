...
def build_request_delete_osdu_welllogacquisition() -> RequestRunner:
    rq_proto = Request(
        name="Delete WellLogAcquisition",
        method="DELETE",
        url="{{base_url}}/ddms/v3/welllogacquisition/{{osdu_welllogacquisition_record_id}}",
        headers={
...
def build_request_get_osdu_welllogacquisition_specific_version() -> RequestRunner:
    rq_proto = Request(
        name="Get WellLogAcquisition specific version",
        method="GET",
        url="{{base_url}}/ddms/v3/welllogacquisition/{{osdu_welllogacquisition_record_id}}/versions/{{osdu_welllogacquisition_record_version}}",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_get_osdu_welllogacquisition() -> RequestRunner:
    rq_proto = Request(
        name="Get WellLogAcquisition",
        method="GET",
        url="{{base_url}}/ddms/v3/welllogacquisition/{{osdu_welllogacquisition_record_id}}",
        headers={
            "accept": "application/json",
...
def build_request_get_versions_of_osdu_welllogacquisition() -> RequestRunner:
    rq_proto = Request(
        name="Get versions of WellLogAcquisition",
        method="GET",
        url="{{base_url}}/ddms/v3/welllogacquisition/{{osdu_welllogacquisition_record_id}}/versions",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_create_osdu_welllogacquisition(b_use_fixed_id=True) -> RequestRunner:
    if b_use_fixed_id:
        id_field = '"id": "{{data_partition}}:master-data--WellLogAcquisition:9cdfd40a-e3b7-506a-968d-0e327a4660df",'
    else:
        id_field = ''

    rq_proto = Request(
        name="Create OSDU WellLogAcquisition",
        method="POST",
        url="{{base_url}}/ddms/v3/welllogacquisition",
        headers={
            "accept": "application/json",
  ...
  "kind": "{{osduWellLogAcquisitionKind}}",
  "tags": {
  ...
  "data": {
    ...
    "ParentProjectID": "namespace:master-data--AnyMasterData:SomeUniqueAnyMasterDataID:",
    "Parameters": [
      {
        "Title": "Example Title",
        "Index": 2,
    ...
    "LogRuns": [
      {
        "LogRunID": "Example LogRunID",
        "GenericToolTypeIDs": [
          "namespace:reference-data--WellLogToolClass:Acoustic:"
        ],
        "ToolMnemonicIDs": [
          "namespace:reference-data--WellLogToolCode:BakerHughesInteq:3DEX:"
        ],
        "SamplingStart": 12345.6,
        "SamplingStop": 12345.6,
        "WellboreFluidTypeID": "namespace:reference-data--WellboreFluidType:Oil:",
        "ConveyanceMethodID": "namespace:reference-data--ConveyanceMethod:ElectricWirelineConveyed:",
        "SensorOffsetDocumentID": "namespace:work-product-component--Document:Document-911bb71f-06ab-4deb-8e68-b8c9229dc76b:",
        "ContractorCompanyID": "namespace:master-data--Organisation:SomeUniqueOrganisationID:",
        "Remarks": [
          {
        ...
        "LogPasses": [
          {
            "LogPassID": "Example LogPassID",
            "PassTypeID": "namespace:reference-data--WellLogPassType:Main:",
            "LoggingDirectionID": "namespace:reference-data--WellLogDirection:Ascending:",
            "IndexTypeID": "namespace:reference-data--WellLogSamplingDomainType:Depth:",
            "SamplingInterval": 0.0254,
            "IsRegularSamplingInterval": true,
            "FlowingConditionID": "namespace:reference-data--WellLogFlowingCondition:NoFLow:",
            "SamplingStart": 12345.6,
            "SamplingStop": 12345.6,
            "WellboreFluidTypeID": "namespace:reference-data--WellboreFluidType:Oil:",
            "HoleTypeIDs": [
              "namespace:reference-data--WellLogHoleType:OpenHole:"
            ],
            "Remarks": [
              {
                "RemarkSequenceNumber": 1,
            ...
            "SampleAcquisitionJobIDs": [
              "namespace:master-data--SampleAcquisitionJob:SomeUniqueSampleAcquisitionJobID:"
            ]
          }
        ]
      }
...
def get_cleaned_ref_and_res() -> dict:
    ...
    ref["kind"] = "opendes:wks:master-data--WellLogAcquisition:1.0.0"
    ref["acl"] = {
