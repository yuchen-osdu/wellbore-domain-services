...
def build_request_delete_osdu_well_100() -> RequestRunner:
    rq_proto = Request(
        name="Delete well",
        method="DELETE",
        url="{{base_url}}/ddms/v3/wells/{{osdu_well_100_record_id}}",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_delete_osdu_well_110() -> RequestRunner:
    rq_proto = Request(
        name="Delete well",
        method="DELETE",
        url="{{base_url}}/ddms/v3/wells/{{osdu_well_110_record_id}}",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_get_osdu_well_100_specific_version() -> RequestRunner:
    rq_proto = Request(
        name="Get well specific version",
        method="GET",
        url="{{base_url}}/ddms/v3/wells/{{osdu_well_100_record_id}}/versions/{{osdu_well_100_record_version}}",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_get_osdu_well_110_specific_version() -> RequestRunner:
    rq_proto = Request(
        name="Get well specific version",
        method="GET",
        url="{{base_url}}/ddms/v3/wells/{{osdu_well_110_record_id}}/versions/{{osdu_well_110_record_version}}",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_get_osdu_well_100() -> RequestRunner:
    rq_proto = Request(
        name="Get well",
        method="GET",
        url="{{base_url}}/ddms/v3/wells/{{osdu_well_100_record_id}}",
...
def build_request_get_osdu_well_110() -> RequestRunner:
    rq_proto = Request(
        name="Get well",
        method="GET",
        url="{{base_url}}/ddms/v3/wells/{{osdu_well_110_record_id}}",
...
def build_request_get_versions_of_osdu_well_100() -> RequestRunner:
    rq_proto = Request(
        name="Get versions of well",
        method="GET",
        url="{{base_url}}/ddms/v3/wells/{{osdu_well_100_record_id}}/versions",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_get_versions_of_osdu_well_110() -> RequestRunner:
    rq_proto = Request(
        name="Get versions of well",
        method="GET",
        url="{{base_url}}/ddms/v3/wells/{{osdu_well_110_record_id}}/versions",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_create_osdu_well_100() -> RequestRunner:
    rq_proto = Request(
        name="Create OSDU well",
        method="POST",
        url="{{base_url}}/ddms/v3/wells",
...
def build_request_create_osdu_well_110() -> RequestRunner:
    rq_proto = Request(
        name="Create OSDU well",
        method="POST",
        url="{{base_url}}/ddms/v3/wells",
...
def get_cleaned_ref_and_res_110() -> dict:
    ref = {
      "tags": {
        "NameOfKey": "String value"
      },
