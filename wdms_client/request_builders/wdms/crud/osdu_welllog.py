...
def build_request_get_osdu_welllog_specific_version() -> RequestRunner:
    rq_proto = Request(
        name="Get welllog specific version",
        method="GET",
        url="{{base_url}}/ddms/v3/welllogs/{{osdu_welllog_record_id}}/versions/{{osdu_welllog_record_version}}",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_get_osdu_welllog() -> RequestRunner:
    rq_proto = Request(
        name="Get welllog",
        method="GET",
...
def build_request_get_versions_of_osdu_welllog() -> RequestRunner:
    rq_proto = Request(
        name="Get versions of welllog",
        method="GET",
        url="{{base_url}}/ddms/v3/welllogs/{{osdu_welllog_record_id}}/versions",
        headers={
            "accept": "application/json",
            "data-partition-id": "{{data_partition}}",
            "Connection": "{{header_connection}}",
...
def build_request_create_osdu_welllog(b_use_fixed_id=True, curves: List[str]=['Example CurveID']) -> RequestRunner:
  ...
  "data": {
    ...
    "WellLogTypeID": "namespace:reference-data--LogType:SomeUniqueLogTypeID:",
    "TopMeasuredDepth": 12345.6,
    "BottomMeasuredDepth": 12345.6,
    "ServiceCompanyID": "namespace:master-data--Organisation:SomeUniqueOrganisationID:",
    "LogSource": "Example LogSource",
    "LogActivity": "Example LogActivity",
    "LogRun": "Example LogRun",
    "LogVersion": "Example LogVersion",
    "LoggingService": "Example LoggingService",
    "LogServiceDateInterval": {
      "StartDate": "2020-02-13T09:13:15.550000+00:00",
      "EndDate": "2020-02-13T09:13:15.550000+00:00"
    },
    "ToolStringDescription": "Example ToolStringDescription",
    "LoggingDirection": "Example LoggingDirection",
    "PassNumber": 2,
    ...
    curves_payload = f'"Curves": [{inner_curves}]'
