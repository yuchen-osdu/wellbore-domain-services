...
variables_dict = {
  ...
  "authorityKind": "slb",
  "osduWellboreKind": "{{authorityKind}}:wks:master-data--Wellbore:1.0.0",
  "osduWellKind": "{{authorityKind}}:wks:master-data--Well:1.0.0",
  "osduWellLogKind": "{{authorityKind}}:wks:work-product-component--WellLog:1.0.0",
