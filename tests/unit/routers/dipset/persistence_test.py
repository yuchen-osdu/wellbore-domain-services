...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
                pd.Series(
                    {"reference": 1000.0, "azimuth": 0.0, "inclination": 18.0, "classification": "fracture"},
                    dtype="object",
                ),
                Dip(
                    reference=ValueWithUnit(unitKey="meter", value=1000.0),
                    azimuth=ValueWithUnit(unitKey="dega", value=0.0),
                    inclination=ValueWithUnit(unitKey="dega", value=18.0),
                    classification="fracture",
                ),
        ),
        ...
        (
            pd.Series(
                {
                    "reference": 0.123456789123456789123456789,
                    "azimuth": 34.0,
                    "inclination": 18.0,
                    "classification": None,
                    "quality": float("nan"),
            ...
            Dip(
                reference=ValueWithUnit(unitKey="meter", value=0.123456789123456789123456789),
                azimuth=ValueWithUnit(unitKey="dega", value=34),
                inclination=ValueWithUnit(unitKey="dega", value=18.0),
                classification=None,
                quality=None,
