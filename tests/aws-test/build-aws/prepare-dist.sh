...
if [ ! -e frozenrequirements_dev.txt ]; then
    echo "File frozenrequirements_dev.txt does not exist!"
else
    cp frozenrequirements_dev.txt tests/aws-test/build-aws/requirements.txt
fi
