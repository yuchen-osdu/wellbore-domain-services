...
class MimeType(NamedTuple):
    ...
    def match(self, str_value: str) -> bool:
        ...
        return any((normalized_value == a_type for a_type in [self.type] + self.alternative_types)) \
...
class MimeTypes:
    ...
    PARQUET = MimeType(
        ...
        extension='.parquet',
        alternative_types=['application/parquet'])  # because https://tools.ietf.org/html/rfc6838#section-3.4
    ...
    MSGPACK = MimeType(
        ...
        extension='.msgpack',
        alternative_types=['application/msgpack',
