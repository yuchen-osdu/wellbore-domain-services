...
@router.post('/fastquery/wellbores', summary="Query with cursor",
        ...
        *:wks:wellbore:* returns all records IDs IDs directly based on existing schemas</p>""")
async def fastquery_wellbores(query: str = None, ctx: Context = Depends(get_ctx)):
    return await search.basic_query_request(query_type, wellbore_kind, ctx, query)
...
async def fastquery_wellbores_bydistance(latitude: float, longitude: float, distance: int, query: str = None,
                ctx: Context = Depends(get_ctx)):
    spatial_filter = search.query_spatial_filter_builder("bydistance", latitude1=latitude, longitude1=longitude,
                                                         distance=distance)
    return await search.query_request_with_spatial_filter(query_type, spatial_filter, ctx, query)
...
async def fastquery_wellbores_byboundingbox(latitude_top_left: float, longitude_top_left: float,
                ...
                query: str = None, ctx: Context = Depends(get_ctx)):
...
@router.post('/fastquery/wellbores/bygeopolygon', summary=f'Query with cursor, CRS format: {crs_format}',
            ...
            <p>The wellbore kind is *:wks:wellbore:* returns all records IDs directly based on existing schemas</p>""")
async def fastquery_wellbores_bygeopolygon(points: List[Point], query: str = None,
                ctx: Context = Depends(get_ctx)):
...
async def fastquery_logsets_bywellbore(wellbore_id: str, query: str = None,
                ctx: Context = Depends(get_ctx)):
    query = search.added_query(wellbore_id, "wellbore", query)
...
@router.post('/fastquery/wellbores/{wellbore_attribute}/logsets',
            ...
            <p>The LogSet kind is *:wks:logSet:* returns all records IDs directly based on existing schemas</p>""")
async def fastquery_logsets_bywellboreattribute(wellbore_attribute: str, query: str = None,
                ctx: Context = Depends(get_ctx)):
...
async def fastquery_logs(query: str = None, ctx: Context = Depends(get_ctx)):
...
async def fastquery_logs_bywellbore(wellbore_id: str, query: str = None,
                ctx: Context = Depends(get_ctx)):
    query = search.added_query(wellbore_id, "wellbore", query)
    return await search.basic_query_request(query_type, log_kind, ctx, query)
...
@router.post('/fastquery/wellbores/{wellbore_attribute}/logs',
            ...
            with this specific attribute will be returned</p>
            <p>The Log kind is *:wks:log:* returns all records IDs directly based on existing schemas</p>""")
async def fastquery_logs_bywellboreattribute(wellbore_attribute: str, query: str = None,
                ctx: Context = Depends(get_ctx)):
...
@router.post('/fastquery/logset/{logset_id}/logs', summary='Query with cursor, search logs IDs by logSet ID',
            ...
            specific ID will be returned</p>
            <p>The Log kind is *:wks:log:* returns all records IDs directly based on existing schemas</p>""")
async def fastquery_logs_bylogset(logset_id: str, query: str = None,
                ctx: Context = Depends(get_ctx)):
    query = search.added_query(logset_id, "logSet", query)
    return await search.basic_query_request(query_type, log_kind, ctx, query)
...
@router.post('/fastquery/logsets/{logset_attribute}/logs',
            ...
            with this specific attribute will be returned</p>
            <p>The Log kind is *:wks:log:* returns all records IDs directly based on existing schemas</p>""")
async def fastquery_logs_bylogsetattribute(logset_attribute: str, query: str = None,
                ctx: Context = Depends(get_ctx)):
...
async def fastquery_markers_bywellbore(wellbore_id: str, query: str = None,
                ctx: Context = Depends(get_ctx)):
    query = search.added_query(wellbore_id, "wellbore", query)
