...
from app.model.osdu_model import (
    ...
    WellLog,
    WellLog110,
    WellLog120, Well110, Wellbore110, WellboreMarkerSet120
)
...
class DMSV3RouterUtils:
    ...
    def validate_record_against_kinds_schema(records: List[Record]):
        ...
        supported_models = {
            "master-data--Well": {"1.0.0": Well, "1.1.0": Well110},
            "master-data--Wellbore": {"1.0.0": Wellbore, "1.1.0": Wellbore110},
