...
class trajectorychannel(DDMSBaseModel):
    ...
    dataType: Optional[DataType_1] = Field(
        'number',
    ...
    format: Optional[Format_1] = Field(
        'float32',
...
class SpatialFilter(DDMSBaseModel):
    ...
    byBoundingBox: Optional[ByBoundingBox] = Field(
        None,
        description='A query allowing to filter hits based on a point location within a bounding box.',
    )
    byDistance: Optional[ByDistance] = Field(
        None,
        description='Filters documents that include only hits that exist within a specific distance from a geo point.',
    )
    byGeoPolygon: Optional[ByGeoPolygon] = Field(
        None,
        description='A query allowing to filter hits that only fall within a polygon of points.',
    )
...
class wellboreData(DDMSBaseModelWithExtra):
    ...
    propertyDictionary: Optional[dict] = Field(
        None,
    ...
    wellHeadWgs84: Optional[core_dl_geopoint] = Field(
        None,
...
class markerData(DDMSBaseModelWithExtra):
    ...
    wgs84LatitudeLongitude: Optional[core_dl_geopoint] = Field(
        None,
...
class wellData(DDMSBaseModelWithExtra):
    ...
    wellLocationType: Optional[WellLocationType] = Field(None, description='', title='')
