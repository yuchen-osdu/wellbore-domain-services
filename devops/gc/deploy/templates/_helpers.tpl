...
{{- define "wellbore.getAutoscaling" -}}
...
{{- define "wellbore.minReplicasSpot" -}}
{{- $tier := include "wellbore.getTier" . -}}
...
{{- define "wellbore.maxReplicasSpot" -}}
{{- $tier := include "wellbore.getTier" . -}}
...
{{- define "wellbore.replicasStandard" -}}
{{- $tier := include "wellbore.getTier" . -}}
